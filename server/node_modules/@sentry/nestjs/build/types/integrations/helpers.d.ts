 ...
 */
export declare function getMiddlewareSpanOptions(target: InjectableTarget | CatchTarget, name?: string | undefined, componentType?: string | undefined): {
    name: string;
    attributes: {
        "sentry.op": string;
 ...
 */
export declare function getBullMQProcessSpanOptions(queueName: string): {
    name: string;
    attributes: Record<string, string>;
    forceTransaction: boolean;
};
