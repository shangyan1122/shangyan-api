...
import { ModifyEWRuleStatusResponse, ModifyFwGroupSwitchRequest, CreateAlertCenterIsolateResponse, DescribeNDRAssetIdentificationListResponse, ModifyAclRuleRequest, DescribeAclRuleResponse, DescribeNatFwInstanceWithRegionResponse, DescribeFwGroupInstanceInfoRequest, DeleteNatFwInstanceResponse, SearchLogResponse, ModifySecurityGroupRuleRequest, CreateSecurityGroupRulesResponse, DescribeNatFwVpcDnsLstRequest, DescribeCfwEipsRequest, RemoveVpcAcRuleRequest, CreateBlockIgnoreRuleListRequest, DescribeAclRuleRequest, ModifyClusterVpcFwSwitchResponse, ExpandCfwVerticalRequest, AddEnterpriseSecurityGroupRulesRequest, DeleteSecurityGroupRuleResponse, ModifyIpsModeSwitchRequest, ModifyAclRuleResponse, CreateNatFwInstanceRequest, DescribeEnterpriseSecurityGroupRuleRequest, CreateAlertCenterOmitRequest, SetNatFwEipResponse, ModifyBlockIgnoreRuleNewResponse, ModifyBlockIgnoreListRequest, ModifyBlockIgnoreRuleRequest, DescribeEnterpriseSGRuleProgressRequest, DescribeNatFwInstancesInfoRequest, DescribeTableStatusRequest, ModifyAddressTemplateResponse, CreateNatFwInstanceWithDomainResponse, DescribeAssetSyncRequest, DeleteVpcFwGroupRequest, ModifySequenceAclRulesResponse, CreateBlockIgnoreRuleNewResponse, DeleteBlockIgnoreRuleListRequest, SyncFwOperateResponse, AddVpcAcRuleResponse, CreateNatFwDnatRuleRequest, CreateAlertCenterRuleRequest, RemoveEnterpriseSecurityGroupRuleRequest, DescribeSecurityGroupListResponse, ModifyEnterpriseSecurityGroupRuleRequest, ModifySequenceRulesResponse, ModifyClusterVpcFwSwitchRequest, DescribeVpcAcRuleResponse, UpdateCheckCcnNonDirectFlagResponse, DescribeFwSyncStatusRequest, DeleteBlockIgnoreRuleNewRequest, DeleteNatFwDnatRuleResponse, ModifyVpcAcRuleResponse, ModifyBlockIgnoreRuleNewRequest, RemoveNatAcRuleResponse, DescribeFwEdgeIpsResponse, SetNatFwEipRequest, DescribeTLogIpListResponse, StopSecurityGroupRuleDispatchResponse, DescribeNatFwInfoCountRequest, SetNatFwDnatRuleRequest, StopSecurityGroupRuleDispatchRequest, DescribeIpsModeSwitchRequest, ModifyBlockTopResponse, DescribeNatFwVpcDnsLstResponse, CreateBlockIgnoreRuleListResponse, DescribeLogsResponse, DescribeClusterVpcFwSwitchsRequest, DeleteAddressTemplateResponse, DescribeCfwEipsResponse, DescribeSwitchListsRequest, DeleteAddressTemplateRequest, DescribeAssociatedInstanceListResponse, ModifyEnterpriseSecurityDispatchStatusRequest, ModifyStorageSettingResponse, CreateAlertCenterRuleResponse, DescribeNatFwInstanceRequest, ModifyNatFwVpcDnsSwitchResponse, CreateBlockIgnoreRuleNewRequest, DescribeCcnInstanceRegionStatusRequest, DescribeNatAcRuleResponse, AddAclRuleRequest, DescribeVpcFwGroupSwitchRequest, ModifyAcRuleResponse, DescribeTableStatusResponse, DescribeTLogInfoResponse, ModifyAllPublicIPSwitchStatusResponse, ModifySecurityGroupItemRuleStatusResponse, DeleteBlockIgnoreRuleListResponse, DescribeNDRAssetIdentificationListRequest, DescribeSwitchErrorRequest, AddVpcAcRuleRequest, ModifyResourceGroupRequest, UpdateClusterVpcFwResponse, DescribeCcnAssociatedInstancesRequest, ModifyVpcAcRuleRequest, DescribeAcListsResponse, AddNatAcRuleRequest, DeleteVpcFwGroupResponse, AddEnterpriseSecurityGroupRulesResponse, DescribeCfwInsStatusResponse, DeleteResourceGroupRequest, CreateAddressTemplateResponse, CreateNatFwDnatRuleResponse, DescribeResourceGroupNewResponse, DescribeAddressTemplateListRequest, RemoveAclRuleRequest, ModifyIpsModeSwitchResponse, DescribeIPStatusListRequest, DescribeFwSyncStatusResponse, DescribeRuleOverviewRequest, DescribeVpcFwCcnPolicyWhiteListRequest, ModifyEWRuleStatusRequest, ModifyNatSequenceRulesRequest, DescribeVpcFwGroupSwitchResponse, ModifyBlockIgnoreRuleResponse, DescribeCcnAssociatedInstancesResponse, ModifyNatFwReSelectRequest, ModifyAllRuleStatusResponse, ModifyAssetSyncRequest, ExpandCfwVerticalResponse, DescribeNatAcRuleRequest, DescribeResourceGroupResponse, DeleteSecurityGroupRuleRequest, DescribeEnterpriseSecurityGroupRuleListResponse, DescribeSecurityGroupListRequest, DescribeCcnInstanceRegionStatusResponse, RemoveVpcAcRuleResponse, ModifySecurityGroupRuleResponse, DescribeSwitchErrorResponse, ModifyTableStatusResponse, DescribeNatFwSwitchRequest, DescribeAddressTemplateListResponse, DescribeLogsRequest, ModifyAssetSyncResponse, DescribeRuleOverviewResponse, ModifyNatAcRuleRequest, DescribeSourceAssetResponse, ModifyNatFwVpcDnsSwitchRequest, DeleteBlockIgnoreRuleNewResponse, ModifyEdgeIpSwitchRequest, DescribeUnHandleEventTabListRequest, UpdateClusterVpcFwRequest, ModifyNatAcRuleResponse, ModifyAssetScanRequest, DescribeEnterpriseSGRuleProgressResponse, CreateVpcFwGroupResponse, DescribeVpcFwCcnPolicyWhiteListResponse, DeleteRemoteAccessDomainResponse, DeleteRemoteAccessDomainRequest, DescribeLogStorageStatisticResponse, DescribeSourceAssetRequest, DescribeCfwInsStatusRequest, DescribeLogStorageStatisticRequest, DescribeFwGroupInstanceInfoResponse, DescribeAssetSyncResponse, ModifyNatSequenceRulesResponse, DescribeNatFwInfoCountResponse, ModifyVpcFwGroupRequest, ModifyEnterpriseSecurityDispatchStatusResponse, ModifyVpcFwSequenceRulesResponse, ModifyVpcFwSequenceRulesRequest, ModifySecurityGroupSequenceRulesRequest, CreateChooseVpcsResponse, ModifyRunSyncAssetResponse, ModifySequenceAclRulesRequest, DescribeResourceGroupNewRequest, ModifyBlockTopRequest, DeleteAcRuleResponse, ModifyNatFwSwitchResponse, DescribeBlockByIpTimesListResponse, DescribeBlockIgnoreListRequest, DescribeBlockIgnoreListResponse, DescribeCcnVpcFwSwitchRequest, DescribeIPStatusListResponse, CreateDatabaseWhiteListRulesRequest, RemoveAclRuleResponse, ModifyStorageSettingRequest, DescribeNatFwDnatRuleRequest, DescribeBlockStaticListRequest, DescribeNatFwSwitchResponse, ModifyAllRuleStatusRequest, ModifyVpcFwGroupResponse, CreateAcRulesResponse, ModifyAssetScanResponse, ModifyAllPublicIPSwitchStatusRequest, RemoveNatAcRuleRequest, DescribeNatFwInstanceResponse, DescribeFwEdgeIpsRequest, ModifyNatInstanceResponse, DescribeBlockStaticListResponse, DescribeIpsModeSwitchResponse, DescribeNatFwInstanceWithRegionRequest, ModifyAddressTemplateRequest, DeleteNatFwDnatRuleRequest, CreateChooseVpcsRequest, ModifyNatInstanceRequest, ModifyBlockIgnoreListResponse, RemoveAcRuleResponse, DescribeCcnVpcFwPolicyLimitResponse, ModifySequenceRulesRequest, DescribeEnterpriseSecurityGroupRuleResponse, ModifyNatFwReSelectResponse, DescribeVpcAcRuleRequest, AddAclRuleResponse, DescribeTLogInfoRequest, SyncFwOperateRequest, DescribeTLogIpListRequest, CreateNatFwInstanceResponse, DescribeCcnVpcFwPolicyLimitRequest, DescribeDefenseSwitchRequest, DescribeCcnVpcFwSwitchResponse, RemoveAcRuleRequest, CreateAddressTemplateRequest, CreateDatabaseWhiteListRulesResponse, DescribeUnHandleEventTabListResponse, DescribeNatFwInstancesInfoResponse, ModifySecurityGroupSequenceRulesResponse, DescribeBlockByIpTimesListRequest, RemoveEnterpriseSecurityGroupRuleResponse, DescribeEnterpriseSecurityGroupRuleListRequest, CreateAlertCenterOmitResponse, ModifyRunSyncAssetRequest, ModifyEdgeIpSwitchResponse, UpdateCheckCcnNonDirectFlagRequest, DeleteNatFwInstanceRequest, SetNatFwDnatRuleResponse, DescribeDefenseSwitchResponse, DescribeAcListsRequest, DeleteAcRuleRequest, ModifyNatFwSwitchRequest, ModifyFwGroupSwitchResponse, CreateAcRulesRequest, DescribeNatFwDnatRuleResponse, DescribeGuideScanInfoRequest, DescribeClusterVpcFwSwitchsResponse, CreateSecurityGroupRulesRequest, CreateVpcFwGroupRequest, CreateNatFwInstanceWithDomainRequest, DescribeSwitchListsResponse, ModifyResourceGroupResponse, DeleteResourceGroupResponse, SearchLogRequest, CreateAlertCenterIsolateRequest, ModifySecurityGroupItemRuleStatusRequest, ModifyAcRuleRequest, ModifyEnterpriseSecurityGroupRuleResponse, AddNatAcRuleResponse, DescribeResourceGroupRequest, DescribeAssociatedInstanceListRequest, ModifyTableStatusRequest, DescribeGuideScanInfoResponse } from "./cfw_models";
/**
 * cfw client
 * @class
 */
