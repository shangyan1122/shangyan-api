...
var MallOrderService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.MallOrderService = void 0;
const common_1 = require("@nestjs/common");
const supabase_client_1 = require("../../storage/database/supabase-client");
let MallOrderService = MallOrderService_1 = class MallOrderService {
    constructor() {
        this.logger = new common_1.Logger(MallOrderService_1.name);
    }
    generateOrderNo() {
    ...
    async getUserOrders(userOpenid, status, page = 1, pageSize = 10) {
        const client = (0, supabase_client_1.getSupabaseClient)();
    ...
    async handlePaymentSuccess(orderNo, transactionId) {
        const client = (0, supabase_client_1.getSupabaseClient)();
    ...
    async shipOrder(orderId, logisticsInfo) {
        const client = (0, supabase_client_1.getSupabaseClient)();
    ...
    async getAllOrders(status, page = 1, pageSize = 20) {
        const client = (0, supabase_client_1.getSupabaseClient)();
        const from = (page - 1) * pageSize;
        const to = from + pageSize - 1;
        let query = client
...
exports.MallOrderService = MallOrderService;
exports.MallOrderService = MallOrderService = MallOrderService_1 = __decorate([
    (0, common_1.Injectable)()
], MallOrderService);
//# sourceMappingURL=mall-order.service.js.map