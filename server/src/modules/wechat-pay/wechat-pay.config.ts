...
function loadPfxCert(): Buffer | undefined {
  const certPath = process.env.WECHAT_PFX_PATH || join(process.cwd(), 'certs', 'apiclient_cert.p12')
...
export const wechatPayConfig: WechatPayConfig = {
  // 小程序 AppID
  appId: process.env.WECHAT_APP_ID || process.env.WECHAT_APPID || 'wx_app_id',
